...
{#if route && progress}
    ...
    <!-- {#if showingCompleted} -->
        <div class="notif growing {showingCompleted ? "notif-in" : "notif-out"}" style:z-index="100">
            ...
            {#if lastCompleted}
                <h2>{lastCompleted.name.toUpperCase()}</h2>
                <p class="description">ON TO THE NEXT!</p>
            {/if}
        </div>
    <!-- {/if} -->
        <div class="overlay {showingCompleted ? "notif-out" : "notif-in"}">
            <div class="top">
                <div class="row">
                    <div class="row">
                    ...
                    <div class="row">
                        <h3 class="objective">{progress.progressPercentage}% TOTAL COMPLETE</h3>
                    </div>
                </div>
            </div>
            <div class="bottom">
